...
public class MoreInformationMapperTest {
    ...
    public void testMapping() throws Exception {
        ...
        assertEquals(moreInfoTypeB.getPrimaryDataCenter(), moreInfo.getDataCenter().get(0));
        assertEquals(moreInfoTypeB.getSecondaryDataCenter(), moreInfo.getDataCenter().get(1));
        ...
        assertEquals(moreInfoTypeB.getDoi(), moreInfo.getDOI().getValue());
    }
}
